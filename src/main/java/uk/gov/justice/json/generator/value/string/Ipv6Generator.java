...
public class Ipv6Generator extends Generator<String> {
    ...
    public static final String PATTERN ="(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|" +
            ...
            "(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\\.){3,3}(25[0-5]|(2[0-4]|1{0,1}" +
            "[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])";
